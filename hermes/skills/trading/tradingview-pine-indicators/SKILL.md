...
详见 `tradingview-indicator-analysis` 技能的 `references/pine-source-live-crossref.md`（未落地·勿引） 和 `references/dmi-table-truth-source.md`（未落地·勿引）。
