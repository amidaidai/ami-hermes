...
本文件是棠溪交易系统的唯一流程总控。分析卡、监控、skill、脚本和复盘都以这里为准；旧模板仅作历史参考。当前权威输出模板：`references/master-template-v68.md` v9.6（表格驾驶舱 · SVP v10 · 多资产）。准确度硬化记录：`references/analysis-accuracy-hardening-2026-07-06.md`。
