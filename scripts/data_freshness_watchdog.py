...
WATCH_FILES = {
    ...
    "x_sentiment.json": {"threshold": 2, "paths": [PROJECT_DATA / "x_sentiment.json", HERMES_DATA / "sentiment.json"]},
    "x_sentiment_context.json": {"threshold": 2, "paths": [PROJECT_DATA / "x_sentiment_context.json", HERMES_DATA / "x_sentiment_context.json"]},
